    ...
    <div>
      <VerticalTimeline lineColor="white">
        ...
        >
          ...
          <p>
            Currently a Year 2 Computer Science student pursuing a Bachelor of
            Computing in Computer Science with Honours degree.
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
        ...
        >
          ...
          <p>
            Was an active member of Nanyang Photographic Society (NYPS). Regularly served as a photographer for different school events.
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
        ...
        >
          ...
          <p>
            Achieved raw L1R5 of 7 points, net L1R5 of 3 points for O Levels.
          </p>
          <p>
            Was appointed an AV team leader of the Infocomm Club, spearheading
            the management of the audio-visual system for major school events.
            Regularly participated in game making competitions.
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
