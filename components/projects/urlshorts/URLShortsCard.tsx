                ...
                <CardContent>
                    <div>
                        ...
                        <h3 className="font-medium mb-4">
                            A simple full-stack web app that provides short and concise URLs for
                            users to share with their friends.
                        </h3>
                        <h3 className="text-l font-medium mb-4">
                            {' '}
                            Pet project inspired by and aimed at replicating the functionality of
                            popular URL shorteners such as TinyURL and bit.ly.
                        </h3>
