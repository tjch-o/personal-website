        ...
        <CardContent>
          <div>
            ...
            <h3 className="font-medium mb-4">
              A website where users can utilise their mouse to engage in
              interactive grid-based drawing and colouring experiences.
            </h3>
            <h3 className="text-l font-medium mb-4">
              {" "}
              One of my first ever web development projects which I completed as
